  ...
  const services = [
    {
      ...
      href: "/es/comprar-propiedad-espana",
      icon: Building2,
    ...
    },
    {
      ...
      href: "/es/inversion-inmobiliaria",
      icon: TrendingUp,
    ...
    },
    {
      ...
      href: "/es/comunidades-propietarios",
      icon: Users,
    ...
    <>
      ...
      <section className="bg-gray-50 text-gray-900 px-6 py-12 md:px-16 lg:px-32 font-sans">
        <div className="max-w-7xl mx-auto">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center text-emerald-600 font-medium">
                      <span>{t.realEstateHub.learnMore || "Leer mas"}</span>
          ...
          {/* Why Choose Section */}
          <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 rounded-lg p-8 mb-12">

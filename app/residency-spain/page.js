...
export default function ResidencySpainArticle() {
  return (
    <>
      <Head>
        <title>
          Opholdstilladelse og statsborgerskab i Spanien | Christian Gefke
        </title>
        <meta
          name="description"
          content="Få juridisk overblik over opholdstilladelse, familiesammenføring og statsborgerskab i Spanien som dansker. Læs om krav, muligheder og hvordan en advokat kan hjælpe."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Opholdstilladelse i Spanien – Hvad skal du vide som dansker?"
        />
        <meta
          property="og:description"
          content="Læs om hvordan du som dansker kan få opholdstilladelse i Spanien, samle familien og ansøge om statsborgerskab."
        />

---
lang: "da"
title: "Komplet Guide til Køb af Bolig i Spanien"
description: "Alt du skal vide om at købe ejendom i Spanien som dansker - fra NIE-nummer til afsluttende omkostninger"
date: "2024-01-15"
author: "Christian Gefke"
authorTitle: "Spansk Advokat"
tags: ["ejendom", "spanien", "boligkøb", "guide"]
keywords: ["køb bolig spanien", "NIE nummer spanien", "spansk ejendom", "ejendomskøb spanien", "dansker købe bolig spanien"]
image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Smuk spansk ejendom med havudsigt"
---
...
|--------|-----------|------|
| Spansk konsulat i Danmark | 2-4 uger | Pas, ansøgningsskema, tidsbestilling |
| Personligt fremmøde på politistation i Spanien | 1-2 uger | Pas, EX-15 formular, begrundelse |
| Gennem juridisk repræsentant | 2-3 uger | Fuldmagt, kopi af pas |
...
✅ Verificerer sælgers juridiske ret til at sælge
✅ Forhandler kontraktvilkår på dine vegne
...
|-----------------|---------|-------|
| **Overdragelsesskat (ITP)** | 6-10% | Varierer efter region; gælder brugte ejendomme |
| **Moms (IVA)** | 10% | Kun nybyggeri (plus 1,5% stempelafgift) |
| **Notargebyr** | 0,5-1% | Baseret på købesum |
| **Tinglysning** | 0,5% | Registrering af ejerskab |
...
|----------|--------|------------------|
| **Nota Simple** | Bekræfter ejerskab og hæftelser | Tinglysningen |
| **Cédula de Habitabilidad** | Beboelsescertifikat | Regional myndighed |
| **IBI-Kvittering** | Bevis for betalt ejendomsskat | Sælger |
| **Fællesudgiftskvitteringer** | Ingen udestående gæld til fællesskabet | Sælger/Administrator |
| **Energimærke** | Energieffektivitetsvurdering | Certificeret tekniker |
| **Byggetilladelse** | Verifikation af lovlig bygning | Kommunen |
...
|--------|-------------------|----------|
| **IBI (Ejendomsskat)** | 0,4-1,1% af matrikelværdi | Årlig |
| **Renovation (Basura)** | €50-150 | Årlig |
| **Fællesudgifter** | €50-300/måned | Månedlig/Kvartalsvis |
...
3. **Ignorer byggelegitimitet** - Ulovlige byggerier er almindelige
4. **Betal kontant "under bordet"** - Det er skatteunddragelse og ulovligt
5. **Antag at forsyninger overføres automatisk** - Det gør de ikke
6. **Glem arveretlige konsekvenser** - Spansk arveret adskiller sig væsentligt

### ✅ Gør:

1. **Besøg ejendommen flere gange** - På forskellige tidspunkter af dagen
2. **Undersøg fællesskabet** - Tal med naboer hvis muligt
3. **Tjek for fremtidige byggerier** - Besøg kommunens planafdeling
4. **Forstå dine skatteforpligtelser** - I både Spanien og Danmark
5. **Gem al dokumentation** - Til skattemæssige formål og fremtidigt salg
...
1. **Få dit NIE tidligt** - Det kræves til alt
2. **Ansæt en uafhængig advokat** - Ikke til forhandling
3. **Budgetter 10-13% ekstra omkostninger** - Ud over købesummen
4. **Gennemfør grundig due diligence** - Før du underskriver noget bindende
5. **Forstå dine løbende forpligtelser** - Skatter, fællesudgifter, vedligeholdelse
...
**Har du brug for hjælp med dit spanske ejendomskøb?** [Kontakt mig](/kontakt) for en uforpligtende samtale. Jeg specialiserer mig i at hjælpe udenlandske købere med at navigere sikkert og effektivt i spansk ejendomsret.

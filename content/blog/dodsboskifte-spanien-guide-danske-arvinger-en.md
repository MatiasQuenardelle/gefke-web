---
lang: "en"
title: "Probate in Spain: Step-by-Step Guide for Danish Heirs"
description: "Complete guide to probate in Spain for Danes. Learn about deadlines, documents, inheritance tax, and the difference between Danish and Spanish inheritance law."
date: "2024-09-05"
lastModified: "2024-11-15"
author: "Christian Gefke"
authorTitle: "Spanish Lawyer"
tags: ["inheritance", "probate", "inheritance law", "inheritance tax", "will"]
keywords: ["probate spain", "inheritance spain foreigner", "estate administration spain", "inheritance tax spain", "danish inheritance law spain", "spanish inheritance law"]
image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Legal documents for probate in Spain"
---

# Probate in Spain: Step-by-Step Guide for Danish Heirs

![Legal documents and signature](https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=800&q=80)
...
| Aspect | Spain | Denmark |
|--------|-------|---------|
| **Process initiation** | Heirs must initiate | Automatic by authorities |
| **Court involvement** | Only if disputes | Probate court standard |
| **Critical deadline** | 6 months for tax | No strict deadline |
| **Heir responsibility** | Full responsibility | Guided by court |
| **Notary role** | Central, public official | Limited |
...
|-------------|-------------|
| ❌ **Interest charges** | Daily interest accrues on the owed tax from deadline expiry |
| ❌ **Fine** | A percentage fine of 5-20% depending on the delay |
| ❌ **Growing burden** | The longer you wait, the more expensive it becomes |
...
|--------|----------|-----------|
| In person in Spain | Police station with foreigners' office | Often same day |
| Via Spanish consulate | Spanish Embassy in Copenhagen | 2-6 weeks |
| By power of attorney | Representative in Spain applies | 1-3 weeks |
...
- The highest of the following three values:
  1. Deed purchase price (if purchased within the last year)
  2. Cadastral value (valor catastral) multiplied by a regional coefficient (typically 1.5-2.0)
...
| Region | Reduction for Close Relatives | Effective Rate |
|--------|-------------------------------|----------------|
| Andalusia | Up to 99% (inheritance under €1M) | ~1% |
| Madrid | 99% for immediate family | ~1% |
| Catalonia | 99% (under €100,000 per child) | 1-5% |
| Valencia | 50-75% for children and spouse | 7-15% |
| Balearic Islands | Moderate reductions | 5-15% |
| Murcia | Very high rates | Up to 36.5% |
...
| Item | Amount |
|------|--------|
| Inheritance: Property | €300,000 |
| Heir: Daughter residing in Denmark | - |
| Personal deduction | -€15,957 |
| Taxable amount | €284,043 |
| Calculated tax before reduction | ~€57,000 |
| Regional reduction (99%) | -€56,430 |
| **Actual tax to pay** | **~€570** |
...
| Item | Amount |
|------|--------|
| Inheritance value | €300,000 |
| Personal deduction | -€25,000 |
| Taxable amount | €275,000 |
| Calculated tax before reduction | ~€55,000 |
| Regional reduction (50%) | -€27,500 |
| **Actual tax to pay** | **~€27,500** |
...
1. Completing form Modelo 650
2. Attaching all documents (death certificate, will, valuation)
3. Paying via bank or online
...
1. Notary reviews all documents
2. Notary verifies heirs' identity
3. The deed of inheritance is read aloud (often a 20-30 minute reading)
4. Heirs sign
5. Notary attests the document
...
2. Verify that inheritance tax has been paid
3. Update the property's title deed
4. Issue a new property certificate (nota simple) with the heirs' names
...
|-----------|---------------|
| Dane who lived permanently in Spain | Spanish inheritance law |
| Dane who lived in Denmark but owned holiday home in Spain | Danish inheritance law |
...
1. Appear clearly and unambiguously in the will
2. Refer to Danish law or Danish nationality
3. Ideally appear in both Danish and Spanish wills
4. Be signed and dated after the EU Regulation's entry into force (August 17, 2015)
...
| Aspect | Danish Inheritance Law | Spanish Inheritance Law |
|--------|------------------------|-------------------------|
| **Spouse's forced share** | 25% of estate | 0% (only usufruct) |
| **Children's forced share** | 25% of estate | 66.7% of estate (legítima) |
| **Free disposition** | 50% of estate | 33.3% of estate |
| **Can spouse inherit everything?** | Yes, by will | No, children always entitled to 2/3 |
| **Succession order without will** | 1) Spouse + children, 2) Parents, 3) Siblings | 1) Children, 2) Parents, 3) Spouse |
...
| Scenario | Wife's Share | Child 1's Share | Child 2's Share |
|----------|--------------|-----------------|-----------------|
| **No will (Spanish law)** | Usufruct of €200,000 | Ownership of €200,000 | Ownership of €200,000 |
| **Danish law chosen in will** | Can inherit all €600,000 | Inherits on wife's death (or forced share of €75,000 now) | Same as Child 1 |
...
|------|-------------|--------|
| 1. Gross inheritance value | | €300,000 |
| 2. Minus funeral costs (max €7,993) | | -€7,993 |
| 3. Net inheritance value | | €292,007 |
| 4. Personal deduction (Group II) | | -€15,957 |
| 5. **Taxable base** | | **€276,050** |
| 6. Calculated tax (progressive scale) | | ~€56,000 |
| 7. Multiplier (wealth under €400,000) | ×1.0 | €56,000 |
| 8. Andalusia reduction (99%) | | -€55,440 |
| 9. **Actual tax to pay** | | **~€560** |

**Same Inheritance in Other Regions:**

| Region | Effective Tax | Reduction from Base Rate |
|--------|---------------|--------------------------|
| Andalusia | €560 | 99% |
| Madrid | €560 | 99% |
| Catalonia | €6,000 | 95% |
| Valencia | €14,000 | 75% |
| Balearic Islands | €28,000 | 50% |
| Murcia | €45,000 | 20% |
| Asturias | €42,000 | 25% |
...
1. **Attempt amicable settlement:** Should always be tried first, often with legal mediation
2. **Executor (contador-partidor):** Court can appoint a neutral executor to handle distribution
3. **Lawsuit (juicio de testamentaría):** Last resort where court makes a decision
...
|--------|-------------|------|
| **Full acceptance** | Heirs take over both assets and liabilities, unlimited liability | High |
| **Acceptance with benefit of inventory** | Heirs liable only up to inheritance value | Low |
| **Rejection of inheritance** | Heir renounces their share entirely | None |
...
| Unpaid IBI and community fees | €5,000 |
| **Net inheritance** | **€45,000** |
...
| Tip | Why It Matters |
|-----|----------------|
| ✅ Start early | Apostille and translation can take 3-4 weeks |
| ✅ Order multiple copies | Often original or certified copy required for different authorities |
| ✅ Track deadlines | Certificate of Last Wills can only be ordered 15 days after death |
| ✅ Keep everything | Keep copies of all documents and receipts |
| ✅ Digitize | Scan all documents and store them securely in the cloud |
...
1. Complete the entire inheritance process (typically 3-6 months)
2. Have the property registered in your/heirs' names
3. Then the property can be sold as normal
...
1. Heir goes to a notary in Denmark
2. Notary issues power of attorney to a person in Spain (often a lawyer or another heir)
3. The power of attorney must be:
...
|-----------|-----------------|
| **The inheritance itself** | NOT taxable in Denmark |
| **If you keep the property** | Annual property value tax (0-3%) |
| **If you sell the property** | Capital gains tax (~42% total effective) |
...
| If Deceased Lived In | Main Probate | Spanish Property |
|---------------------|--------------|------------------|
| Spain | Spain | Included in Spanish probate |
| Denmark | Denmark | Processed separately in Spain |
...
|-------|----------------|
| ✅ **6-month deadline is absolute** | Start immediately and seek extension if necessary |
| ✅ **Spanish will is essential** | Create it when purchasing property |
| ✅ **NIE number for all heirs** | Apply early to avoid delays |
| ✅ **Valuation must be realistic** | Avoid artificially low valuations |
| ✅ **Use professional help** | A Spanish lawyer is a necessary investment |
...
| Cost Item | Amount |
|-----------|--------|
| Inheritance tax | €500-30,000 (depending on region) |
| Notary | €600-1,200 |
| Stamp duty | €1,500-4,500 |
| Lawyer | €1,500-3,000 |
| Documents, translations, apostilles | €500-1,000 |
| **Total** | **€4,600-40,200** |
...
1. Contact a Spanish lawyer with estate experience within the first weeks
2. Start collecting documents immediately
3. Apply for NIE for all heirs
4. Get clarity on deadlines and next steps

**If you're considering buying property in Spain:**
1. Create a Spanish will at the same time as purchase
2. Include choice of law clause (choosing Danish law)
3. Coordinate with your Danish will
4. Consider inheritance tax consequences when choosing region
...
I have many years of experience guiding Danish heirs through the Spanish inheritance process. [Contact me](/en/contact) for a non-binding conversation, or write directly to cbgefke@gmail.com / WhatsApp +45 93 84 18 22.

**Useful links:**
- [Registro General de Actos de Última Voluntad](https://www.mjusticia.gob.es/es/ciudadanos/tramites/solicitud-certificado) - Spanish Will Registry
- [Danish Civil Affairs Agency - Apostille](https://civilstyrelsen.dk/sagsomraader/apostille) - Danish documents for abroad
- [Sede Electrónica del Catastro](https://www.sedecatastro.gob.es/) - Cadastral value lookup

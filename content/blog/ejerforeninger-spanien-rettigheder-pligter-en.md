---
lang: "en"
title: "Homeowner Associations in Spain: Your Rights and Obligations as a Foreign Owner"
description: "Complete guide to Spanish homeowner associations (Comunidad de Propietarios). Learn about community fees, general meetings, voting rights, and how to protect your interests."
date: "2024-12-18"
lastModified: "2024-12-20"
author: "Christian Gefke"
authorTitle: "Spanish Lawyer"
tags: ["homeowner association", "comunidad de propietarios", "community fees", "general meeting", "property ownership"]
keywords: ["homeowner association spain", "comunidad de propietarios", "community fees spain", "general meeting spain", "gastos de comunidad", "junta de propietarios", "administrator spain"]
image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Spanish residential complex with pool and common areas"
---

# Homeowner Associations in Spain: Your Rights and Obligations as a Foreign Owner

![Modern apartment complex with shared pool](https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80)
...
| Aspect | Details |
|--------|---------|
| **Legal Regulation** | Ley de Propiedad Horizontal (Horizontal Property Law) |
| **In Force Since** | 1960, last revised 2013 and 2023 |
| **Supplemented By** | The association's own bylaws (*estatutos*) |
| **Membership** | Automatic and mandatory when you buy |
...
|--------------------|-------------|
| **Property Size/Value** | Your property's size and value relative to the entire complex |
| **Fee Share** | Your share of community expenses |
| **Income Share** | Your share of any community income |
| **Voting Weight** | Your voting weight for decisions (though typically 1 vote = 1 property) |
...
| Category | Expenses Included |
|----------|-------------------|
| **Fixed Operating Costs** | Pool maintenance, gardening, electricity for common areas, water for pool/garden, elevator service, common waste disposal |
| **Personnel** | Caretaker (*conserje*), cleaning staff, security personnel |
| **Insurance** | Building insurance for common parts, liability insurance |
...
|---------------|-------------|
| Small apartment complex (10-20 units), no pool | €30-60 |
| Medium complex with pool | €80-150 |
| Large complex with pool, garden, security | €150-300 |
...
|--------|----------------|
| **Direct Debit** (*domiciliación bancaria*) | Most recommended—automatic monthly deduction |
| **Manual Transfer** | Requires you to remember; risk of delay |
| **Cash to Administrator** | Rare in modern complexes—always demand receipt! |

> **⚠️ IMPORTANT: Update your payment details when buying!**
> When you buy the property, you must immediately:
...
|-------|----------|--------------|
| **Reminder** | 0-3 months behind | Reminder letter, late payment interest (typically 10-12% annually), collection fee (€50-100) |
| **Legal Action** | 3-6 months behind | CP can sue you, legal costs added to your debt (typically €1,000-3,000 extra in lawyer fees) |
| **Lien & Forced Sale** | 6+ months behind | CP can register a lien on your property, property can be auctioned, you lose the property |
...
> **💡 IMPORTANT: Always check before buying!**
> As a buyer, you (via your lawyer) should always obtain:
...
| **Typical Timing** | First quarter (January-March), or before summer in tourist areas |
| **Notice Period** | At least **6 days** before the meeting (some bylaws require 15 days) |
...
| Call | Requirement |
|------|-------------|
| **First Call** | Typically requires majority (50%+ of cuotas) |
| **Second Call** | Often no quorum requirement (those present can decide) |
...
Often the administrator serves as chair.
...
Each item is discussed and voted on.
...
|------------------|-------------------|----------|
| **Simple Majority** | 50%+ of present votes | Approval of accounts, approval of budget, ordinary maintenance, administrator's fee |
| **Qualified Majority** | 3/5 of all cuotas | Major renovation projects, installation of new facilities, **ban on holiday rentals** (NEW from 2023), changes in use of common areas |
| **Unanimity** | 100% | Change of cuota de participación, amendment of bylaws (in many CPs), change of facade or architecture, merger or division of units |
...
**Legal Significance:**
The minutes are legally binding. If you were not at the meeting and disagree, you normally have **30 days** to challenge the decision in court.
...
|-------------|------------|
| CP could not ban holiday rentals | CP can now **legally ban** or **restrict** holiday rentals |
...
**2. Restriction:**
"Maximum 20% of units may be used for holiday rentals."

**3. Special Requirements:**
"Holiday rental is permitted subject to:
...
1. **Proposal** is made (by administrator, board, or owners)
2. **Notice** for general meeting with proposal on agenda
3. **Discussion** at the meeting
4. **Vote:** Requires **3/5 of all cuotas** (not just those present!)
5. **Adoption** in bylaws
6. **Registration** of amended bylaws
...
| Source | Sanctions |
|--------|-----------|
| **From CP** | Fine (set in bylaws, e.g., €3,000-10,000), loss of voting rights, lawsuit from CP, demand for immediate cessation |
| **From Authorities** | Municipal fines for illegal rental (€10,000-40,000), denial of tourist license |

> **💡 Advice for Buyers:**
> BEFORE buying a holiday home with rental plans:
> 1. ❗ Read the bylaws carefully
> 2. ❗ Get written confirmation that rental is permitted
> 3. ❗ Check minutes from recent general meetings (has a ban been discussed?)
> 4. ❗ Have a lawyer review everything
...
| Category | Tasks |
|----------|-------|
| **Administrative** | Prepare budget and accounts, collect community fees, bookkeeping, correspondence with owners, document filing |
| **Meetings** | Call general meetings, take minutes, advise on decisions |
...
| Type | Pros | Cons |
|------|------|------|
| **Professional Administrator** | Trained and experienced, knows the law, has administration tools, objective and independent | Costs money (€0.50-2 per unit per month + VAT) |
| **Resident Administrator** | Free or very cheap, knows the complex well, engaged in the community | Often lacks experience, time-consuming, risk of personal conflicts |
...
| Action | Requirement |
|--------|-------------|
| **Appointment** | Decision at general meeting, simple majority, contract typically for 1-3 years |
| **Dismissal** | Also requires only simple majority, can happen at ordinary or extraordinary meeting |
...
Typically paid according to two models:

| Model | Typical Amount |
|-------|----------------|
| **Fixed Monthly Amount per Unit** | €5-15/unit/month + VAT (21%) |
| **Percentage of Budget** | 5-10% of annual budget |
...
1. **First:** Talk to the neighbor directly (politely!)
2. **Then:** Complain to administrator
3. **If Not Resolved:** Attend general meeting and discuss
4. **Last Resort:** Lawsuit (expensive and slow)

**House Rules (*normas de convivencia*):**
Most CPs have house rules in the bylaws:
...
1. **Participate actively in the general meeting** and vote against
2. **Propose alternative solution** with lower cost
3. **Demand multiple quotes** from different contractors
4. **Accept the decision** if the majority votes for it

**Can You Refuse to Pay?**
No! If the general meeting with correct majority decides on an expense, you are bound—even if you voted against.
...
| Step | Description |
|------|-------------|
| **1. Dialogue** | Always try friendly dialogue first |
| **2. Mediation** | Some CPs use a mediator (*mediador*) for conflicts |
| **3. General Meeting** | Get the issue on the agenda—community opinion can help |
| **4. Legal Assistance** | Contact lawyer if CP makes illegal decisions, you're wrongfully denied rights, or there are serious bylaw violations |
| **5. Lawsuit** | Last resort. Expensive (€5,000-15,000+) and slow (1-3 years) |
...
3. **Attend general meetings:** Either in person or by power of attorney
4. **Network with other owners:** Find other English speakers in the complex
5. **Use the administrator actively:** Ask if in doubt!
...
1. **Before buying:** Investigate the CP thoroughly—request all documents
2. **When buying:** Have lawyer review everything, confirm no debt
3. **After buying:** Update contact info with administrator immediately
4. **Ongoing:** Pay on time, attend general meetings, stay informed
5. **If problems arise:** Start with dialogue, use administrator, get legal help if needed
...
**Need help with Spanish homeowner association matters?** [Contact me](/contact) for a consultation.

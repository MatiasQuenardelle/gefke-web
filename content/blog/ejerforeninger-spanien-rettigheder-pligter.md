...
| Type ejendom | Fællesudgift/måned |
|--------------|-------------------|
| Lille lejlighedskompleks (10-20 enheder), ingen pool | 30-60 EUR |
| Mellemstort kompleks med pool | 80-150 EUR |
| Stort kompleks med pool, have, sikkerhed | 150-300 EUR |
| Luksuskompleks med multiple pools, fitness, concierge | 300-600+ EUR |
...
**Betalingsmetode:**
1. **Automatisk træk** (*domiciliación bancaria*):
...
3. **Kontant til administrator:**
   - Sjældent i moderne komplekser
   - Kræv altid kvittering!

**VIGTIGT: Opdater din betaling ved køb!**
Når du køber ejendommen, skal du straks:
...
**VIGTIGT: Tjek altid før køb!**
Som køber skal du (via din advokat) altid indhente:
...
**Indkaldelse:**
Skal ske mindst **6 dage før** mødet (i nogle vedtægter 15 dage).
...
**Undtagelse:**
I nogle vedtægter kan stemmevægt være proportional med cuota. Tjek dine vedtægter!
...
**Repræsentation:**
Hvis du ikke kan deltage, kan du:
...
Ofte er administratoren mødeleder.
...
**4. Diskussion og afstemning**
Hver sag diskuteres og stemmes om.
...
**2. Begrænsning:**
"Maksimalt 20% af enhederne må anvendes til ferieudlejning."

**3. Særlige krav:**
"Ferieudlejning er tilladt under forudsætning af:
...
1. **Forslag** fremsættes (af administrator, bestyrelse eller ejere)
2. **Indkaldelse** til generalforsamling med forslaget på dagsorden
3. **Diskussion** på mødet
4. **Afstemning:** Kræver **3/5 af alle cuotas** (ikke bare fremmødte!)
5. **Vedtagelse** i vedtægter
6. **Tinglysning** af ændrede vedtægter
...
**Råd til købere:**
FØR du køber en feriebolig med henblik på udlejning:
1. ❗ Læs vedtægterne grundigt
2. ❗ Få skriftlig bekræftelse at udlejning er tilladt
3. ❗ Tjek referater fra seneste generalforsamlinger (er forbud diskuteret?)
4. ❗ Få advokat til at gennemgå alt
...
**Små komplekser** (10-20 enheder): Ofte beboer-administrator
**Mellemstore og store komplekser:** Typisk professionel
...
**Professionelle administratorer:**
Typisk betaling efter to modeller:

1. **Fast månedligt beløb per enhed:**
   - 5-15 EUR/enhed/måned + moms (21%)
   - Eksempel: Kompleks med 40 enheder à 10 EUR = 400 EUR/måned + moms

2. **Procentdel af budget:**
...
1. **Først:** Tal med naboen direkte (venligt!)
2. **Derefter:** Klag til administrator
3. **Hvis ikke løst:** Mød op på generalforsamling og diskutér
4. **Sidste udvej:** Retssag (dyrt og langsomt)

**Husordensregler (*normas de convivencia*):**
De fleste CP har husordensregler i vedtægterne:
...
**Scenarie:**
CP beslutter stor renovering (f.eks. nyt tag til 80.000 EUR). Du synes det er for dyrt eller unødvendigt.

**Dine muligheder:**

1. **Deltag aktivt i generalforsamlingen** og stem imod
2. **Foreslå alternativ løsning** med lavere omkostning
3. **Kræv flere tilbud** fra forskellige entreprenører
4. **Accepter beslutningen** hvis majoritet stemmer for

**Kan du nægte at betale?**
Nej! Hvis generalforsamlingen med korrekt flertal beslutter en udgift, er du bundet - selv om du stemte imod.

**Undtagelse:**
Hvis beslutningen var ulovlig (f.eks. forkert flertal, manglende indkaldelse), kan du sagsøge for at få den annulleret.
...
**Proces:**
1. Rapporter til administrator
2. Administrator sender påkrav til overtrædende ejer
3. Hvis ikke rettet: CP kan sagsøge
4. Domstol kan kræve genetablering

### Hvordan Løses Konflikter?

**1. Dialog:**
Prøv altid først venlig dialog.

**2. Mægling:**
Nogle CP bruger mægler (*mediador*) ved konflikter.

**3. Generalforsamling:**
Få sagen på dagsorden - fællesskabets mening kan hjælpe.

**4. Juridisk bistand:**
Kontakt advokat hvis:
- CP træffer ulovlige beslutninger
- Du uretmæssigt nægtes rettigheder
- Der er alvorlige overtrædelser af vedtægter

**5. Retssag:**
Sidste udvej. Dyrt (5.000-15.000+ EUR) og langsomt (1-3 år).
...
**1. Opdater din kontaktinfo:**
Sørg for administrator har:
- ✉️ Din postadresse (i Danmark eller Spanien)
- 📧 Din email
- 📱 Dit telefonnummer

**2. Læs indkaldelser grundigt:**
Selv om det er på spansk, få det oversat hvis der er vigtige beslutninger.

**3. Deltag i generalforsamlinger:**
Enten fysisk eller ved fuldmagt.

**4. Netværk med andre ejere:**
Find andre danskere eller engelsktalende i komplekset.

**5. Brug administrator aktivt:**
...
1. **Før køb:** Undersøg CP grundigt - anmod om alle dokumenter
2. **Ved køb:** Få advokat til at gennemgå alt, bekræft ingen gæld
3. **Efter køb:** Opdater kontaktinfo hos administrator med det samme
4. **Løbende:** Betal til tiden, deltag i generalforsamlinger, følg med
5. **Ved problemer:** Start med dialog, brug administrator, få juridisk hjælp hvis nødvendigt

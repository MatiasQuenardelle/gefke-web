---
lang: "en"
title: "Holiday Rental in Spain: Licenses, Rules and Requirements 2025"
description: "Complete guide to legally renting out your holiday home in Spain. Learn about tourist licenses, regional requirements, homeowner association approval, and tax obligations."
date: "2024-10-10"
lastModified: "2024-12-20"
author: "Christian Gefke"
authorTitle: "Spanish Lawyer"
tags: ["rental", "tourist license", "holiday home", "airbnb", "short-term rental", "homeowner association"]
keywords: ["holiday rental spain rules", "tourist license spain", "rent holiday home spain", "airbnb spain rules", "VUT license spain", "short-term rental spain legal", "homeowner association approval rental"]
image: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Holiday home in Spain ready for rental"
---

# Holiday Rental in Spain: Licenses, Rules and Requirements 2025

![Modern holiday home with bright colors and terrace](https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=800&q=80)
...
| Issue | Impact |
|-------|--------|
| **Housing shortage for locals** | Long-term rentals converted to tourist rental |
| **Price increases** | Rents have risen dramatically |
| **Neighborhood deterioration** | "Hotelization" of residential areas |
| **Noise nuisance and disturbances** | Neighbor complaints about partying tourists |
...
> If you're considering buying a holiday home for rental purposes:
> 1. Request a **copy of the homeowner association's bylaws** (*estatutos*)
> 2. Read **minutes from recent general meetings** (*actas de junta*)
> 3. Ask **explicitly**: May the property be rented for tourism?
> 4. Get it **confirmed in writing**
...
|----------|--------------|
| **Barcelona** | Near-total stop for new tourist licenses since 2016; only specific zones allow applications |
| **Palma (Mallorca)** | Ban on tourist rental in city center apartments; only single-family houses and specially approved buildings |
| **Seville** | Certain historic districts have restrictions; maximum number of licenses per block |
| **Málaga** | No new licenses in center; restrictions in popular zones like Málaga Este |

**How to Check:**
1. Contact your municipality's **tourism office** (*departamento de turismo*)
2. Check the municipality's website for rules on *viviendas turísticas*
3. Some municipalities have online maps with permitted/not-permitted zones
4. Ask a local *gestor* or lawyer
...
| **Catalonia** | HUTB/HUT (*Habitatge d'Ús Turístic*) |
| **Balearic Islands** | VT/ETV (*Estancia Turística en Vivienda*) |
...
|------|----------|-------------|
| **1. Preparation** | 2-4 weeks | Gather all necessary documents; ensure property meets all requirements; take professional photos |
| **2. Application** | 1 day | Complete application online or via *gestor*; upload documents; pay fee (€50-150 typical) |
| **3. Processing** | 1-3 months | Authorities review application; possible property inspection; opportunity to correct deficiencies |
...
| Aspect | Details |
|--------|---------|
| **License Type** | VFT (*Vivienda con Fines Turísticos*) |
| **Characteristics** | Relatively liberal legislation; mandatory registration in tourism registry; A/C and heating required |
| **Authority** | Junta de Andalucía - Consejería de Turismo |
| **Application** | Online via SITA system |
| **Fee** | Approx. €50 |
| **Processing Time** | 1-2 months |
| **Renewal** | Not necessary (license valid until revoked) |
...
| Aspect | Details |
|--------|---------|
| **License Type** | VT (*Vivienda Turística*) |
| **Characteristics** | Stricter than Andalusia; separate entrance required; minimum 2 bedrooms for apartments |
| **Authority** | Generalitat Valenciana - Agència Valenciana del Turisme |
| **Fee** | Approx. €60 |
| **Processing Time** | 2-3 months |
| **Renewal** | Every 5 years |
| **Restrictions** | Valencia city: very limited; Benidorm: separate rules; Altea, Calpe, Dénia: moderately accessible |
| **Fines** | €2,000-600,000 |
...
| Aspect | Details |
|--------|---------|
| **License Type** | HUT (*Habitatge d'Ús Turístic*) |
| **Characteristics** | **Very strict** legislation; Barcelona nearly closed for new licenses; requires energy rating E or better |
| **Authority** | Generalitat de Catalunya |
| **Fee** | Approx. €100 |
| **Processing Time** | 3-4 months |
| **Renewal** | Permanent (but can be revoked) |
| **Restrictions** | **Barcelona:** moratorium since 2016 - nearly impossible; Sitges, Girona: very tight; Costa Brava (small towns): more accessible |
| **Fines** | €3,000-600,000 |
...
| Aspect | Details |
|--------|---------|
| **License Type** | ETV (*Estancia Turística en Vivienda*) |
| **Characteristics** | **Very strict**; annual moratorium in certain periods; only single-family houses on Mallorca; minimum distance between tourist properties |
| **Fee** | Approx. €100 |
| **Processing Time** | 2-3 months |
| **Renewal** | Every 5 years |
| **Restrictions** | Palma: only single-family houses, not apartments; Ibiza: strict restrictions; minimum 5-7 day rental in high season |
| **Fines** | €4,000-400,000 |
...
| Aspect | Details |
|--------|---------|
| **License Type** | VV (*Vivienda Vacacional*) |
| **Characteristics** | Must not be in tourist zones with hotels; must be in residential zones |
| **Fee** | Approx. €50 |
| **Processing Time** | 1-2 months |
| **Restrictions** | Tenerife south (tourist zones): very difficult; Gran Canaria (Maspalomas etc.): restrictions; Lanzarote, Fuerteventura: more accessible |
| **Fines** | €2,000-400,000 |
...
**Tax Base:**
For EU citizens, you can deduct **actual expenses** (up to 50% of income):
...
**Double Taxation?**
No! Most countries provide **relief** for Spanish tax paid (credit method). You pay the highest rate, but not double.
...
|----------|--------------|
| **Airbnb** | "License number" or "Registration number" field must be filled correctly; Airbnb checks and can remove listings without valid number |
| **Booking.com** | Similar requirements; platforms are required to enforce this |
...
| Expense | Estimate |
|---------|----------|
| **Lawyer/gestor** (help with application) | €300-800 |
| **License fee** (regional authority) | €50-150 |
| **Air conditioning** (if not already installed) | €500-1,500 |
| **Fire extinguisher, first aid kit** | €50-100 |
| **Smoke alarm** | €20-50 |
| **Professional photos** | €100-300 |
| **Liability insurance** (first year) | €150-300 |
...
| Expense | Estimate |
|---------|----------|
| **Gestor** (quarterly Modelo 210) | €200-400/year |
| **Liability insurance** | €150-300/year |
| **Platform fees** (Airbnb/Booking 14-18%) | 14-18% of income |
| **Cleaning** (between each guest) | €50-80 per guest |
| **Linen washing/changing** | €15-25 per guest |
| **Maintenance** (ongoing repairs) | €500-1,000/year |
| **Utilities** (electricity, water - guests use more) | €600-1,200/year |
...
| Method | Description |
|--------|-------------|
| **Platform Control** | Airbnb and Booking.com are required to check license numbers; in some regions they report directly to authorities |
| **Neighbor Reports** | Neighbors are often the first to report, especially with noise issues or many changing guests |
...
|-----------|----------------|--------------|
| Rental without license | Serious | €10,000-40,000 |
| Rental despite ban (homeowner association/zone) | Very serious | €20,000-100,000 |
| False information in application | Very serious | €20,000-100,000 |
| Lack of hygiene or safety | Serious | €4,000-40,000 |
| Not displaying license number | Minor | €2,000-4,000 |
| Not reporting guests | Minor | €300-3,000 |
| Exceeding max. capacity | Serious | €6,000-40,000 |
...
| Category | Advantages |
|----------|------------|
| **Fewer Rules** | No tourist license required; no homeowner association approval needed; no A/C/heating requirements; simpler administration |
...
|----------|---------------|
| **Lower Income** | Long-term rent: €600-1,000/month vs. tourist rental often 2-3× more per month |
| **Tenant Protection** | Difficult to get tenant to leave (strong tenant protection in Spain); if tenant doesn't pay, can take 6-12 months to get eviction order |
| **Limited Personal Use** | You cannot use the property when you want; typically only between tenancy periods |
...
**Key Points:**
1. **Check first:** May your property even be rented? (Homeowner association + zone rules)
2. **Get license:** Apply for the correct tourist license for your region
3. **Meet requirements:** Air conditioning, heating, safety, documents
4. **Compliance:** Quarterly tax, guest reporting, correct advertising
5. **Costs:** Be realistic—it costs €1,500-3,500 to start, plus ongoing expenses
...
**The Alternative:**
Long-term rental provides lower income but much less administrative hassle and no risk of large fines.
...
**Need help with holiday rental in Spain?** [Contact me](/contact) for a consultation.

**Useful Links:**
- [Junta de Andalucía - Tourism Registry](https://www.juntadeandalucia.es/organismos/turismoculturaydeporte/areas/turismo/registro-turismo.html)
- [Agencia Tributaria - Modelo 210](https://sede.agenciatributaria.gob.es/Sede/procedimientoini/G322.shtml)
- [Policía Nacional - Guest Registration](https://webpol.policia.es/e-hotel/)

---
lang: "en"
title: "Moving to Spain as a Pensioner: Complete Tax Checklist 2025"
description: "Everything you need to know about moving to Spain as a Danish pensioner. Tax, health insurance, pension, registration, and the most important deadlines."
date: "2024-08-28"
lastModified: "2024-11-25"
author: "Christian Gefke"
authorTitle: "Spanish Lawyer"
tags: ["pensioners", "relocation", "tax", "health", "registration"]
keywords: ["moving to spain pensioner", "pensioner spain tax", "danish pensioner spain", "relocating spain", "pension spain taxation"]
image: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Elderly couple enjoying life under the Spanish sun"
---

# Moving to Spain as a Pensioner: Complete Tax Checklist 2025

![Elderly couple enjoying the view by the Mediterranean](https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=800&q=80)
...
|-------|----------|-------------|
| **Phase 1** | 3-6 months before | Planning, tax deregistration, pension, health insurance |
| **Phase 2** | 0-3 months | Registration in Spain, NIE, Residencia, healthcare |
| **Phase 3** | First year | Tax obligations, Modelo 720, annual deadlines |
...
|----------|-------------|
| ✅ Wait to move | Wait until 5 years have passed since your last contribution |
| ✅ Stop contributions early | Stop at least 5 years before planned move |
| ✅ Use Retirement Savings | The last years before moving: Only pay into retirement savings (does NOT trigger exit taxation) |
| ✅ Apply for exemption | SKAT can grant exemption in special cases (rarely given) |
...
**Private Pensions:**
Also contact your private pension companies:
...
|-----------|-------------|
| ✅ Shorter waiting times | Skip long public queues |
| ✅ Free choice | Choose your hospital and doctor |
| ✅ Dental coverage | Not included in public system |
| ✅ Language | Danish/English-speaking doctors |
...
|-----------|-----------------|----------------|
| **Sell** | Capital gains taxed in Denmark | Avoid property value tax going forward |
| **Keep and rent out** | Must be taxed in Denmark (primary taxation right) | Also reported in Spain, relief for Danish tax |
| **Leave empty** | Must pay property value tax in Denmark | Consider inheritance implications |
...
|-------------|---------------|
| **Finances** | Pension payments, bank statements (typically €6,000-7,000/year required) |
| **Health insurance** | S1 form (best) OR private health insurance |
...
| Category | Examples |
|----------|----------|
| 1. Bank accounts abroad | Danish savings accounts |
| 2. Securities | Stocks, bonds, investment funds |
| 3. Real estate outside Spain | Danish apartment or house |
...
| Region | Threshold | Primary Home Deduction | Rates |
|--------|-----------|----------------------|-------|
| **Andalusia** | €700,000 | €300,000 | 0.2% - 3.75% |
| **Madrid** | Effectively abolished | N/A | 100% rebate |
| **Catalonia** | €500,000 | Lower | Higher rates |
...
| Your Assets | Amount |
|-------------|--------|
| Spanish home (primary residence) | €350,000 |
| Danish home | €270,000 |
...
|--------------|----------------------|-------|
| **State pension (Folkepension)** | Denmark (withholding) | Also reported in Spain (relief) |
| **ATP** | Denmark (withholding) | Like state pension |
| **Annuity pension (Ratepension)** | Denmark (withholding) | Like state pension |
| **Life annuity (Livrente)** | Denmark (withholding) | Like state pension |
| **Capital pension** | Denmark (lump sum) | Taxed as capital income |
| **Retirement savings (Aldersopsparing)** | Denmark (lump sum) | Lower tax than capital pension |
| **Civil servant pension (Tjenestemandspension)** | ALWAYS Denmark | Special rule for public pensions |
...
| Country | Tax | Savings |
|---------|-----|---------|
| Denmark | ~30-35% = €7,500-8,750 | - |
| Spain | Personal deduction ~€5,500, Taxable €19,500, Tax ~€2,500-3,000 | €4,500-5,750/year |
...
| Item | Denmark | Spain | Difference |
|------|---------|-------|------------|
| Restaurant dinner (2 persons) | 600 DKK | 280 DKK | -53% |
| Groceries (monthly) | 4,000 DKK | 2,800 DKK | -30% |
| Electricity (monthly) | 800 DKK | 600 DKK | -25% |
| Gasoline (per liter) | 14 DKK | 10 DKK | -29% |
| Property tax (typical) | 8,000 DKK/year | 2,000 DKK/year | -75% |
| Health insurance | Free (via tax) | Free (S1) | 0% |
...
| When | What |
|------|------|
| **March** | Modelo 720 (only if assets increased >€20,000) |
| **May** | Danish tax return (if Danish income) |
| **June** | Spanish tax return (Modelo 100) |
| **Sept-Nov** | Payment of IBI (property tax), check community fees |
| **Ongoing** | Utilities payments, health insurance (if private) |
...
**Are you considering moving to Spain?** [Contact me](/en/contact) for a non-binding conversation about your situation. You can also write directly to cbgefke@gmail.com or via WhatsApp at +45 93 84 18 22.

**Useful links:**
- [Udbetaling Danmark - S1 Form](https://www.borger.dk/sundhed-og-sygdom/sygesikring-og-laegevalg/sundhedskort-i-udlandet) - Apply for health coverage
- [SKAT - Moving Abroad](https://www.skat.dk/borger/udland/naar-du-flytter-til-udlandet) - Tax departure
- [Agencia Tributaria - Modelo 720](https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI34.shtml) - Foreign assets
- [Cita Previa - NIE/Residencia](https://sede.administracionespublicas.gob.es/icpplus/) - Book appointment

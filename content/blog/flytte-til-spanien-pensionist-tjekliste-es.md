---
lang: "es"
title: "Mudarse a España como Jubilado: Lista de Verificación Fiscal Completa 2025"
description: "Todo lo que necesita saber sobre mudarse a España como jubilado danés. Impuestos, seguro médico, pensión, registro y los plazos más importantes."
date: "2024-08-28"
lastModified: "2024-11-25"
author: "Christian Gefke"
authorTitle: "Abogado Español"
tags: ["jubilados", "mudanza", "impuestos", "salud", "registro"]
keywords: ["mudarse a españa jubilado", "jubilado españa impuestos", "jubilado danés españa", "trasladarse españa", "pensión españa tributación"]
image: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Pareja de jubilados disfrutando de la vida bajo el sol español"
---

# Mudarse a España como Jubilado: Lista de Verificación Fiscal Completa 2025

![Pareja de jubilados disfrutando de la vista junto al Mediterráneo](https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=800&q=80)
...
| Fase | Período | Áreas de Enfoque |
|------|---------|------------------|
| **Fase 1** | 3-6 meses antes | Planificación, baja fiscal, pensión, seguro médico |
| **Fase 2** | 0-3 meses | Registro en España, NIE, Residencia, sanidad |
| **Fase 3** | Primer año | Obligaciones fiscales, Modelo 720, plazos anuales |
...
|------------|-------------|
| ✅ Esperar para mudarse | Espere hasta que hayan pasado 5 años desde su última aportación |
| ✅ Dejar de aportar temprano | Deje de aportar al menos 5 años antes de la mudanza prevista |
| ✅ Usar Ahorro para Jubilación | Los últimos años antes de mudarse: Solo aporte al ahorro para jubilación (NO activa la tributación de salida) |
| ✅ Solicitar exención | SKAT puede conceder exención en casos especiales (raramente concedida) |
...
**Pensiones Privadas:**
También contacte a sus compañías de pensiones privadas:
...
| Ventaja | Descripción |
|---------|-------------|
| ✅ Tiempos de espera más cortos | Evite las largas colas públicas |
| ✅ Libre elección | Elija su hospital y médico |
| ✅ Cobertura dental | No incluida en el sistema público |
| ✅ Idioma | Médicos que hablan danés/inglés |
...
|-------------|------------------------|-----------------|
| **Vende** | Ganancias de capital tributan en Dinamarca | Evita impuesto sobre valor de propiedad en adelante |
| **Mantiene y alquila** | Debe tributar en Dinamarca (derecho de tributación primario) | También se declara en España, deducción por impuesto danés |
| **Deja vacía** | Debe pagar impuesto sobre valor de propiedad en Dinamarca | Considere implicaciones hereditarias |
...
|-----------|---------------|
| **Finanzas** | Pagos de pensión, extractos bancarios (normalmente se requieren 6.000-7.000 €/año) |
| **Seguro médico** | Formulario S1 (mejor) O seguro médico privado |
...
| Categoría | Ejemplos |
|-----------|----------|
| 1. Cuentas bancarias en el extranjero | Cuentas de ahorro danesas |
| 2. Valores | Acciones, bonos, fondos de inversión |
| 3. Bienes inmuebles fuera de España | Apartamento o casa danesa |
...
| Región | Umbral | Deducción Vivienda Habitual | Tipos |
|--------|--------|---------------------------|-------|
| **Andalucía** | 700.000 € | 300.000 € | 0,2% - 3,75% |
| **Madrid** | Efectivamente abolido | N/A | Bonificación 100% |
| **Cataluña** | 500.000 € | Menor | Tipos más altos |
...
| Sus Activos | Cantidad |
|-------------|----------|
| Vivienda española (residencia habitual) | 350.000 € |
| Vivienda danesa | 270.000 € |
...
|-----------------|---------------------------|-------|
| **Pensión estatal (Folkepension)** | Dinamarca (retención) | También se declara en España (deducción) |
| **ATP** | Dinamarca (retención) | Como pensión estatal |
| **Pensión de anualidad (Ratepension)** | Dinamarca (retención) | Como pensión estatal |
...
| **Ahorro jubilación (Aldersopsparing)** | Dinamarca (suma única) | Menor impuesto que pensión de capital |
| **Pensión funcionario (Tjenestemandspension)** | SIEMPRE Dinamarca | Regla especial para pensiones públicas |
...
| País | Impuesto | Ahorro |
|------|----------|--------|
| Dinamarca | ~30-35% = 7.500-8.750 € | - |
| España | Deducción personal ~5.500 €, Base imponible 19.500 €, Impuesto ~2.500-3.000 € | 4.500-5.750 €/año |
...
| Concepto | Dinamarca | España | Diferencia |
|----------|-----------|--------|------------|
| Cena restaurante (2 personas) | 600 DKK | 280 DKK | -53% |
| Alimentación (mensual) | 4.000 DKK | 2.800 DKK | -30% |
| Electricidad (mensual) | 800 DKK | 600 DKK | -25% |
| Gasolina (por litro) | 14 DKK | 10 DKK | -29% |
| Impuesto propiedad (típico) | 8.000 DKK/año | 2.000 DKK/año | -75% |
| Seguro médico | Gratis (vía impuestos) | Gratis (S1) | 0% |
...
| Cuándo | Qué |
|--------|-----|
| **Marzo** | Modelo 720 (solo si activos aumentaron >20.000 €) |
| **Mayo** | Declaración danesa (si ingresos daneses) |
| **Junio** | Declaración española (Modelo 100) |
| **Sept-Nov** | Pago del IBI (impuesto propiedad), verificar gastos comunidad |
| **Continuo** | Pagos de suministros, seguro médico (si privado) |
...
**¿Está considerando mudarse a España?** [Contácteme](/es/contacto) para una conversación sin compromiso sobre su situación. También puede escribir directamente a cbgefke@gmail.com o vía WhatsApp al +45 93 84 18 22.

**Enlaces útiles:**
- [Udbetaling Danmark - Formulario S1](https://www.borger.dk/sundhed-og-sygdom/sygesikring-og-laegevalg/sundhedskort-i-udlandet) - Solicitar cobertura sanitaria
- [SKAT - Traslado al Extranjero](https://www.skat.dk/borger/udland/naar-du-flytter-til-udlandet) - Salida fiscal
- [Agencia Tributaria - Modelo 720](https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI34.shtml) - Activos en extranjero
- [Cita Previa - NIE/Residencia](https://sede.administracionespublicas.gob.es/icpplus/) - Pedir cita

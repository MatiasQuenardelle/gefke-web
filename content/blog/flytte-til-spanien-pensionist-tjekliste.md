---
lang: "da"
title: "Flytte til Spanien som Pensionist: Komplet Skattemæssig Tjekliste 2025"
description: "Alt du skal vide om at flytte til Spanien som dansk pensionist. Skat, sundhedsforsikring, pension, registrering og de vigtigste frister."
date: "2024-08-28"
lastModified: "2024-11-25"
author: "Christian Gefke"
authorTitle: "Spansk Advokat"
tags: ["pensionister", "udflytning", "skat", "sundhed", "registrering"]
keywords: ["flytte til spanien pensionist", "pensionist spanien skat", "dansk pensionist spanien", "udflytning spanien", "pension spanien beskatning"]
image: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Ældre par nyder livet under den spanske sol"
---

# Flytte til Spanien som Pensionist: Komplet Skattemæssig Tjekliste 2025

![Ældre par nyder udsigten ved Middelhavet](https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=800&q=80)
...
**Sådan gør du:**
1. Book tid hos Borgerservice i din kommune
2. Medbring dokumentation for bopæl i Spanien:
   - Lejekontrakt eller skøde
   - Evt. elaftale eller andet bevis
3. Angiv fraflytningsdato (typisk din faktiske flyttedag)
4. Få kvittering for afmeldingen
...
**Vigtigt at vide:**
Selv om du fraflytter Danmark, skal du stadig selvangive i Danmark, hvis du har dansk indkomst (hvilket de fleste pensionister har via deres pension under ny ordning).
...
**Eksempel:**
Du betalte 50.000 kr. ind på din ratepension i 2020 og fik ca. 20.000 kr. i skattefradrag (40%). Hvis du flytter i 2024, skal du efterbeskattes af de 50.000 kr., hvilket kan koste dig omkring 20.000 kr. i ekstra skat.

**Sådan undgår du efterbeskatning:**

1. **Vent med at flytte**
   - Vent til der er gået 5 år siden sidste indbetaling

2. **Stop indbetalinger i god tid**
   - Stop minimum 5 år før planlagt flytning

3. **Brug Aldersopsparing i stedet**
...
**Private pensioner:**
Kontakt også dine private pensionsselskaber:
...
1. **Du skal først have NIE-nummer** (se næste fase)
2. Gå til bank med:
   - Pas
   - NIE-certifikat
   - Bopælsattest (Padrón)
3. De opretter kontoen samme dag
4. Du får:
   - Kontonummer (IBAN)
   - Betalingskort
   - Online banking
...
1. **Find din kommunes Ayuntamiento (rådhus)**
2. **Book tid eller mød op** (varierer mellem kommuner)
3. **Medbring:**
   - Pas (original + kopi)
   - Bevis for bopæl:
...
5. **Få Certificado de Empadronamiento**
   - Typisk samme dag
...
Du skal dokumentere:
1. **Økonomi:** At du kan forsørge dig selv
   - Pensionsudbetalinger
   - Bankkontoudtog
   - Typisk krav: 6.000-7.000 EUR/år
2. **Sundhedsforsikring:** At du har dækning
...
2. Værdipapirer (aktier, obligationer, investeringsforeninger)
...
**I praksis:**
Du betaler typisk størstedelen af skatten til Danmark, mens Spanien får en mindre del (eller intet, hvis dansk skat er højere end spansk).

### Hvilke pensioner beskattes hvor?

Her er en oversigt:

| Pensionstype | Beskatning (ny ordning) | Bemærkninger |
|--------------|------------------------|--------------|
| **Folkepension** | Danmark (kildeskat) | Indberettes også i Spanien (lempelse) |
| **ATP** | Danmark (kildeskat) | Som folkepension |
| **Ratepension** | Danmark (kildeskat) | Som folkepension |
| **Livrente** | Danmark (kildeskat) | Som folkepension |
| **Kapitalpension** | Danmark (engangsbeløb) | Beskattes som kapitalindkomst |
| **Aldersopsparing** | Danmark (engangsbeløb) | Lavere skat end kapitalpension |
| **Tjenestemandspension** | ALTID Danmark | Særregel for offentlige pensioner |

**Særligt om tjenestemandspension:**
Hvis du har tjenestemandspension (fra stat, region eller kommune), beskattes den ALTID i Danmark - uanset om du er under gammel eller ny ordning.
...
| Post | Danmark | Spanien | Forskel |
|------|---------|---------|---------|
| Restaurant middag (2 pers) | 600 kr | 280 kr | -53% |
| Dagligvarer (månedligt) | 4.000 kr | 2.800 kr | -30% |
| El (månedligt) | 800 kr | 600 kr | -25% |
| Benzin (liter) | 14 kr | 10 kr | -29% |
| Ejendomsskat (typisk) | 8.000 kr/år | 2.000 kr/år | -75% |
| Sundhedsforsikring | Gratis (skat) | Gratis (S1) | 0% |
...
**Fejlen:**
Flytter til Spanien men forbliver tilmeldt CPR i Danmark.
...
**Løsning:**
Afmeld dig aktivt hos Borgerservice.

### 2. Ikke ansøge om S1 i tide

**Fejlen:**
Flytter uden at have S1-blanket.
...
**Løsning:**
Ansøg om S1 mindst 2 måneder før flytning.

### 3. Tro man slipper for spansk selvangivelse

**Fejlen:**
"Jeg betaler jo skat i Danmark, så jeg behøver ikke selvangive i Spanien."
...
**Løsning:**
Selvangiv i BEGGE lande hvert år.

### 4. Undervurdere formueskatten

**Fejlen:**
Tror ikke der er formueskat eller glemmer at indregne den.
...
**Løsning:**
Beregn din formue og eventuel formueskat INDEN flytning.

### 5. Ikke lave spansk testamente

**Fejlen:**
"Mit danske testamente må være nok."
...
**Løsning:**
Lav spansk testamente samtidig med boligkøb.

### 6. Glemme Modelo 720

**Fejlen:**
Indberetter ikke sin danske formue via Modelo 720.
...
**Løsning:**
Husk Modelo 720 inden 31. marts første år.

### 7. Beholde kun dansk bank

**Fejlen:**
Får ikke spansk bankkonto.
...
**Løsning:**
Åbn spansk konto straks efter ankomst.

### 8. Ikke forstå efterbeskatning

**Fejlen:**
Flytter inden 5 år efter sidste pensionsindbetaling.
...
**Løsning:**
Planlæg flytning mindst 5 år efter sidste indbetaling, eller brug aldersopsparing.

### 9. Undervurdere sprogbarrier

**Fejlen:**
Tror alle taler engelsk i Spanien.
...
**Løsning:**
Lær basalt spansk, eller brug tolk ved vigtige møder.

### 10. Ikke søge professionel rådgivning

**Fejlen:**
Prøver at klare det hele selv uden hjælp.
...
**Løsning:**
Brug dansk-talende advokat/skatterådgiver første år.
...
Overvejer du at flytte til Spanien? [Kontakt mig](/kontakt) for en uforpligtende samtale om din situation. Du kan også skrive direkte på cbgefke@gmail.com eller via WhatsApp på +45 93 84 18 22.

**Nyttige links:**
- [Udbetaling Danmark - S1 blanket](https://www.borger.dk/sundhed-og-sygdom/sygesikring-og-laegevalg/sundhedskort-i-udlandet) - Ansøg om sundhedsdækning
- [SKAT - Fraflytning](https://www.skat.dk/borger/udland/naar-du-flytter-til-udlandet) - Skattemæssig fraflytning
- [Agencia Tributaria - Modelo 720](https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI34.shtml) - Udenlandsk formue
- [Cita Previa - NIE/Residencia](https://sede.administracionespublicas.gob.es/icpplus/) - Book tid

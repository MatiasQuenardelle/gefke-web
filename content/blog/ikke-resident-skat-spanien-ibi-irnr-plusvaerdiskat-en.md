---
lang: "en"
title: "Non-Resident Taxes in Spain: IBI, IRNR, and Capital Gains Explained"
description: "Complete guide to taxes for non-residents with property in Spain. Learn about IBI, IRNR (Modelo 210), capital gains tax when selling, and annual obligations."
date: "2024-09-20"
lastModified: "2024-12-20"
author: "Christian Gefke"
authorTitle: "Spanish Lawyer"
tags: ["tax", "non-resident", "property tax", "modelo 210", "IBI", "capital gains"]
keywords: ["non-resident tax spain", "IBI tax spain", "capital gains tax spain", "property tax spain foreigner", "modelo 210", "IRNR", "spanish property tax"]
image: "https://images.unsplash.com/photo-1586348943529-beaae6c28db9?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Tax forms and documents for property tax"
---

# Non-Resident Taxes in Spain: IBI, IRNR, and Capital Gains Explained

![Tax calculation for property in Spain](https://images.unsplash.com/photo-1586348943529-beaae6c28db9?auto=format&fit=crop&w=800&q=80)
...
| Tax Type | Who Pays? | Typical Amount | Deadline |
|----------|-----------|----------------|----------|
| **IBI** | All owners | €150-500/year | Municipal, typically Sept-Nov |
| **IRNR (Modelo 210)** | Non-residents only | €150-300/year | December 31 of following year |
| **Capital Gains Tax** | When selling | 19-23% of gain + municipal plusvalía | At time of sale |
...
**Payment Methods:**
1. **Direct Debit:** The easiest way - set up automatic payment (*domiciliación bancaria*) from your Spanish bank account
2. **Manual Payment:** Pay at the bank or online with the received payment slip
3. **Early Payment Discount:** Many municipalities offer 5% discount for early payment
...
| Consequence | Details |
|-------------|---------|
| **Late Payment Surcharge** | 5-20% depending on delay |
| **Interest** | Approximately 3-4% annually |
| **Property Lien** | Municipality can register a charge |
| **Sale Problems** | IBI debt must be cleared before deed signing |
...
✅ Also if the property is rented (but with different calculation)
...
| Cadastral Revision | Calculation |
|--------------------|-------------|
...
**Calculation:**
1. Taxable Base: €120,000 × 1.1% = €1,320
2. IRNR: €1,320 × 19% = **€250.80 annually**
...
**How to File:**
1. Go to [www.agenciatributaria.es](https://www.agenciatributaria.es)
2. Select "Modelo 210"
3. Complete the form with:
   - Your NIE number
   - Property cadastral value
   - Property address and reference
4. Calculate the tax (system does it automatically)
5. Pay online via card or bank transfer
...
| Sale Price | €300,000 |
| 3% Retention | €9,000 |
| You Receive at Signing | €291,000 |
...
| Period | Obligation |
|--------|------------|
| **April-May** | Some municipalities collect IBI with early payment discount |
...
|-------------|--------------|
| **IBI** | 5-20% fines, interest, property lien, sale blocked |
...
### Advantages:
✅ Ensures timely payments and filings
✅ Keeps track of all deadlines
✅ Handles communication with Spanish authorities
...
|---------|--------------|
| Basic Fee | €150-250/year |
| Modelo 210 Filing | €50-100/year |
| IBI Follow-up | Often included |
| Rental Accounting | €300-500/year extra |
...
1. **IBI:** Municipal property tax (€150-500/year) - paid annually
2. **IRNR (Modelo 210):** State non-resident tax (€150-400/year) - filed annually by December 31
3. **Capital Gains Tax:** When selling - both state (19-23%) and municipal
...
**Need help navigating Spanish property taxes?** [Contact me](/contact) for a consultation. I help foreign property owners manage their Spanish tax obligations.

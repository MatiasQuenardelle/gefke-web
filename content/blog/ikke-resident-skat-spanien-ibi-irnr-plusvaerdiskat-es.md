---
lang: "es"
title: "Impuestos para No Residentes en España: IBI, IRNR y Plusvalía Explicados"
description: "Guía completa de impuestos para no residentes con propiedades en España. Aprende sobre IBI, IRNR (Modelo 210), impuesto sobre ganancias patrimoniales y obligaciones anuales."
date: "2024-09-20"
lastModified: "2024-12-20"
author: "Christian Gefke"
authorTitle: "Abogado Español"
tags: ["impuestos", "no residente", "IBI", "modelo 210", "IRNR", "plusvalía"]
keywords: ["impuestos no residentes españa", "IBI españa", "plusvalía españa", "impuesto propiedad extranjeros", "modelo 210", "IRNR", "ganancias patrimoniales españa"]
image: "https://images.unsplash.com/photo-1586348943529-beaae6c28db9?auto=format&fit=crop&w=1200&q=80"
imageAlt: "Formularios y documentos de impuestos inmobiliarios"
---

# Impuestos para No Residentes en España: IBI, IRNR y Plusvalía Explicados

![Cálculo de impuestos para propiedades en España](https://images.unsplash.com/photo-1586348943529-beaae6c28db9?auto=format&fit=crop&w=800&q=80)
...
| Tipo de Impuesto | ¿Quién Paga? | Importe Típico | Plazo |
|------------------|--------------|----------------|-------|
| **IBI** | Todos los propietarios | €150-500/año | Municipal, típicamente sept-nov |
| **IRNR (Modelo 210)** | Solo no residentes | €150-300/año | 31 diciembre del año siguiente |
| **Plusvalía** | Al vender | 19-23% de ganancia + plusvalía municipal | En el momento de la venta |
...
|--------------|----------|
| **Recargo por Demora** | 5-20% según el retraso |
| **Intereses** | Aproximadamente 3-4% anual |
| **Embargo sobre la Propiedad** | El ayuntamiento puede registrar una carga |
| **Problemas de Venta** | La deuda de IBI debe liquidarse antes de firmar la escritura |
...
✅ También si la propiedad se alquila (pero con cálculo diferente)
...
| Revisión Catastral | Cálculo |
|--------------------|---------|
| Revisada después de 1994 | Valor Catastral × 1,1% |
| NO revisada después de 1994 | Valor Catastral × 2% |
...
**Cómo Presentar:**
1. Ve a [www.agenciatributaria.es](https://www.agenciatributaria.es)
...
| Concepto | Importe |
|----------|---------|
| Precio de Compra 2015 | €200.000 |
| Gastos de Compra | €20.000 |
| Reformas 2018 | €15.000 |
...
| Período | Obligación |
|---------|------------|
| **Abril-Mayo** | Algunos ayuntamientos cobran IBI con descuento por pronto pago |
...
| Impago | Consecuencias |
|--------|---------------|
| **IBI** | Multas 5-20%, intereses, embargo sobre propiedad, venta bloqueada |
| **IRNR (Modelo 210)** | Multas desde €100 hasta 50% del impuesto, intereses, problemas de venta |
| **En la Venta** | El comprador debe obtener certificado de estar al corriente; la venta no puede proceder sin él |
...
### Ventajas:
✅ Asegura pagos y presentaciones puntuales
✅ Controla todos los plazos
✅ Gestiona la comunicación con autoridades españolas
...
|----------|--------------|
| Cuota Básica | €150-250/año |
| Presentación Modelo 210 | €50-100/año |
| Seguimiento IBI | A menudo incluido |
| Contabilidad de Alquileres | €300-500/año extra |
...
**¿Necesitas ayuda navegando los impuestos inmobiliarios españoles?** [Contáctame](/contacto) para una consulta. Ayudo a propietarios extranjeros a gestionar sus obligaciones fiscales en España.

...
/**
 * Generate LocalBusiness schema for Google Maps/Local Pack rich results
...
/**
 * Generate AggregateRating schema for star ratings in SERPs
 * @param {number} ratingValue - Average rating value (e.g., 4.9)
 * @param {number} reviewCount - Total number of reviews (e.g., 47)
